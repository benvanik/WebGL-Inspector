(function () {
    ...
    var StateSnapshot = function (sourceSnapshot) {
        for (var n in sourceSnapshot) {
            this[n] = sourceSnapshot[n];
        }
    };

    function getTargetValue(value) {
        if (value) {
            if (value.mirroredObject) {
                return value.mirroredObject;
            } else {
                return value;
            }
        } else {
    ...
    replay.StateSnapshot = StateSnapshot;
