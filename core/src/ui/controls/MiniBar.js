(function () {
    ...
    Object.defineProperty(MiniBar.prototype, "enabled", {
        ...
        set: function setEnabled(value) {
            if (this.enabled_ !== value) {
                for (var name in this.segments) {
                    this.segments[name].enabled = value;
                }
            }
            this.enabled_ = value;
        }
    ...
    Object.defineProperty(MiniBarSegment.prototype, "enabled", {
        get: function getEnabled() { return this.enabled_; },
        set: function setEnabled(value) {
            if (this.enabled_ !== value) {
                for (var name in this.items) {
                    this.items[name].enabled = value;
                }
            }
            this.enabled_ = value;
        }
