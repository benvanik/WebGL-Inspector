...
cd ui
cat Window.js LeftListing.js TraceView.js TraceListing.js TraceInspector.js TimelineView.js StateView.js TextureView.js BufferView.js ProgramView.js > ../cat.ui.js
cd ..
