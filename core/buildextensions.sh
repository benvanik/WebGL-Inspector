...
cd ui
cat Window.js LeftListing.js SurfaceInspector.js TraceLine.js TraceView.js TraceListing.js TimelineView.js StateView.js TextureView.js TexturePicker.js BufferView.js ProgramView.js > ../cat.ui.js
cd ..
